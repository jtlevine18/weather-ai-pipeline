...
_SYSTEM_PROMPT = (
    ...
    "The SMS blocks are mandatory — responses without them are invalid.\n\n"
    "Respond with EXACTLY these four blocks, in this order, with nothing else:\n\n"
    "ENGLISH:\n"
    "<the English version, 3-5 sentences>\n\n"
    "LOCAL:\n"
    "<the same advisory in the requested local language, same length>\n\n"
    "SMS_ENGLISH:\n"
    "<≤160 char English SMS — required, never empty>\n\n"
    "SMS_LOCAL:\n"
    "<≤160 char SMS in the requested local language — required, never empty>"
)
