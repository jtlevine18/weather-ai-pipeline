...
def check_clean_row_count(postgres: PostgresResource) -> AssetCheckResult:
...
def check_clean_temp_nulls(postgres: PostgresResource) -> AssetCheckResult:
    conn = postgres.get_connection()
    try:
...
def check_clean_temp_range(postgres: PostgresResource) -> AssetCheckResult:
    conn = postgres.get_connection()
    try:
...
def check_forecast_confidence(postgres: PostgresResource) -> AssetCheckResult:
    conn = postgres.get_connection()
    try:
