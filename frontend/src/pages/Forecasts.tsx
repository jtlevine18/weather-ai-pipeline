  ...
  return (
    <div className="space-y-6">
      ...
      <PageContext id="forecasts">
        Seven-day forecasts for all 20 stations, generated by NeuralGCM (Google DeepMind) with Open-Meteo as fallback. When enough observation data accumulates, an XGBoost MOS model corrects systematic biases. Each forecast is spatially downscaled to individual farmer GPS coordinates.
      </PageContext>
