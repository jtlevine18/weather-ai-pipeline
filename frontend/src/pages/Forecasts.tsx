  ...
  return (
    <div className="space-y-6">
      ...
      <PageContext id="forecasts">
        Forecasts are generated by NeuralGCM (Google DeepMind's neural weather model) on GPU. A machine learning correction layer improves accuracy as more data accumulates. Each forecast is adjusted to individual farmer GPS coordinates using NASA satellite data.
      </PageContext>
      ...
      {hasNeuralGCM && (
        <div style={{
          ...
          <span style={{ color: '#3730a3', fontSize: '0.85rem' }}>
            NeuralGCM (Google DeepMind) is the active weather model for this pipeline run
          </span>
        </div>
      )}
