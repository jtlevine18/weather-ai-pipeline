...
const HERO_STEPS = [
  ...
  },
  {
    ...
    body: "Google DeepMind's GraphCast — an open neural weather model running at 0.25° (~28km) resolution — produces a seven-day global forecast. Each station's twelve-year observation history is then used to correct for local bias, and satellite grids interpolate the result to each farmer's exact GPS coordinates with an elevation adjustment.",
